...
- JavaScript (ES2020+) (React processor UI) + React 18, Vite bundler (frontend), Material UI v5, papaparse (CSV), jsRofex (NEEDS CLARIFICATION: library availability / API surface) (004-integrate-jsrofex-to)
- `localStorage` for session token & sync metadata; in-memory React state for operations list (004-integrate-jsrofex-to)
...
- localStorage (006-arbitraje-de-plazos)
...
- 004-integrate-jsrofex-to: Added JavaScript (ES2020+) (React processor UI) + React 18, Vite bundler (frontend), Material UI v5, papaparse (CSV), jsRofex (NEEDS CLARIFICATION: library availability / API surface)
