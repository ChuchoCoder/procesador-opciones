...
- JavaScript ES2020+ (frontend React 18.x application) + React 18.3.1, Material UI v7.3.4, papaparse 5.5.3 (CSV parsing), Vite 7.1.7 (bundler), vitest 3.2.4 (testing) (008-unified-processing-pipeline)
- Browser localStorage for persisted configuration and settings; chrome.storage for browser extension sync; in-memory state for operations data during processing (008-unified-processing-pipeline)
...
## Recent Changes
- 008-unified-processing-pipeline: Added JavaScript ES2020+ (frontend React 18.x application) + React 18.3.1, Material UI v7.3.4, papaparse 5.5.3 (CSV parsing), Vite 7.1.7 (bundler), vitest 3.2.4 (testing)
